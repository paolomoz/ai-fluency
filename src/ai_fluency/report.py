...
def generate_report(
    ...
    lines.append("")
    lines.append("For each behavior, assess on a 0-5 scale aligned with CEFR language levels:")
    lines.append("- **0-0.9 — A1 Breakthrough**: No evidence of this behavior")
    lines.append("- **1-1.9 — A2 Elementary**: Occasional or inconsistent evidence")
    lines.append("- **2-2.9 — B1 Intermediate**: Regular evidence but room for improvement")
    lines.append("- **3-3.89 — B2 Upper Intermediate**: Consistent evidence, some gaps")
    lines.append("- **3.9-4.49 — C1 Advanced**: Consistent, effective demonstration")
    lines.append("- **4.5-5.0 — C2 Mastery**: Sophisticated, nuanced mastery")
    lines.append("")
